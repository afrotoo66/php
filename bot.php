...
*/
ob_start();
$API_KEY = '6770706013:AAExlaeOTufqVWesUMPVcLkBtNCZY055W9s';
...
$alwsh = "@IIUll_l";
$sudo = "5904216848";
$Dev = array("5904216848","",""); //ID ADMIN NUMBER 1 HE CHAT
//****************//
@$usernamebot = "Solyuibot"; //UserName Bot
@$channel = "T_Y_E_X"; // UserName Channel don't @
@$token = API_KEY;
...
if(!in_array("GG1ZZ",$_GG1ZZ_) and !in_array("AFROTOO",$unid)){
...
if($text == "تعين الايدي" || $text == "تغير الايدي" || $text == "تعيين الايدي"){
	...
	file_put_contents("data/ids/id_.txt","AFROTOO");
	bot("sendMessage",[
	'chat_id'=>$chat_id,
	'text'=>$loran22,
	'parse_mode'=>"MARKDOWN",
...
if($text == "تعطيل الايدي" and $JJ117 == "creator" || $JJ117 == "administrator" || $from_id == $sudo || in_array($from_id,$dev) || in_array($from_id,$manger)){file_put_contents("data/ids/unid.txt","AFROTOO");bot("SendMessage",["chat_id"=>$chat_id,"text"=>"",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}if($text == "تفعيل الايدي" and $JJ117 == "creator" || $JJ117 == "administrator" || $from_id == $sudo || in_array($from_id,$dev) || in_array($from_id,$manger)){file_put_contents("data/ids/unid.txt","");bot("SendMessage",["chat_id"=>$chat_id,"text"=>"",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}
if(!$re and in_array($text,$command) and in_array("AFROTOO",$unid)){bot("sendmessage",["chat_id"=>$chat_id,"text"=>"- سلامتك شو صار لايدك😾",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}
if($text=="صورتي"){
...
",
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"آلـمـطـور ™",'url'=>"t.me/IIUll_l"]],
]])
]);
}}
...
if($message->text and file_exists("data/addrd/$text.txt")) {
    $AFROTOO = file_get_contents("data/addrd/$text.txt");
   bot('SendMessage',[
    'chat_id'=>$chat_id,
    'text'=>$AFROTOO,
    'parse_mode'=>"MARKDOWN",
 ...
 if($message->text and file_exists("data/addrd/media/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/$text.txt");
   bot('Sendvoice',[
    'chat_id'=>$chat_id,
    'voice'=>$AFROTOO,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/media/audio/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/audio/$text.txt");
 bot('SendAudio',[
    'chat_id'=>$chat_id,
    'audio'=>$AFROTOO,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/media/sticker/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/sticker/$text.txt");
 bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/media/video/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/video/$text.txt");
bot('Sendvideo',[
'chat_id'=>$chat_id,
'video'=>$AFROTOO,
...
if($message->text and file_exists("data/addrd/media/photo/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/photo/$text.txt");
bot('Sendphoto',[
'chat_id'=>$chat_id,
'photo'=>$AFROTOO,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/media/videonote/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/videonote/$text.txt");
 bot('Sendvideonote',[
'chat_id'=>$chat_id,
'video_note'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/media/document/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/media/document/$text.txt");
 bot('SendDocument',[
'chat_id'=>$chat_id,
'document'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/media/contact/$text.txt")) {
 $AFROTOO = file_get_contents("data/addrd/media/contact/$text.txt");
bot('SendContact',[
'chat_id'=>$chat_id,
'phone_number'=>$AFROTOO,
'first_name'=>$message->from->first_name,
'last_name'=>$message->from->last_name,
'reply_to_message_id'=>$message->message_id,
]);
 ...
 if($message->text and file_exists("data/addrd/$chat_id/$text.txt")) {
    $AFROTOO = file_get_contents("data/addrd/$chat_id/$text.txt");
   bot('SendMessage',[
    'chat_id'=>$chat_id,
    'text'=>$AFROTOO,
    'parse_mode'=>"MARKDOWN",
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/$text.txt");
   bot('Sendvoice',[
    'chat_id'=>$chat_id,
    'voice'=>$AFROTOO,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/audio/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/audio/$text.txt");
 bot('SendAudio',[
    'chat_id'=>$chat_id,
    'audio'=>$AFROTOO,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/sticker/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/sticker/$text.txt");
 bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/video/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/video/$text.txt");
bot('Sendvideo',[
'chat_id'=>$chat_id,
'video'=>$AFROTOO,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/$chat_id/media/photo/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/photo/$text.txt");
bot('Sendphoto',[
'chat_id'=>$chat_id,
'photo'=>$AFROTOO,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/$chat_id/media/videonote/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/videonote/$text.txt");
 bot('Sendvideonote',[
'chat_id'=>$chat_id,
'video_note'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/document/$text.txt")) {
  $AFROTOO = file_get_contents("data/addrd/$chat_id/media/document/$text.txt");
 bot('SendDocument',[
'chat_id'=>$chat_id,
'document'=>$AFROTOO,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/contact/$text.txt")) {
 $AFROTOO = file_get_contents("data/addrd/$chat_id/media/contact/$text.txt");
bot('SendContact',[
'chat_id'=>$chat_id,
'phone_number'=>$AFROTOO,
'first_name'=>$message->from->first_name,
...
$user          = $update->message->from->username;
$buyy          = "@IIUll_l"; // معرفك
$sudo         = 5904216848; // ايديك.
$bot_id       =6770706013; // ايدي بوتك .
$from_id     = $message->from->id;
$re         = $update->message->reply_to_message;
$re_id      = $update->message->reply_to_message->from->id;
$re_user      = $update->message->reply_to_message->from->username;
...
$AFROTOO = count($pirvate)-1;
$AFROTOOd = count($groups)-1;
...
bot('sendMessage',[
 ...
 ⚜• تم ارسال رسالتك الى $AFROTOO عضو و $AFROTOOd من مجموعات البوت ،💗ء*",
'parse_mode'=>"MARKDOWN",
'reply_to_message_id'=>$message->message_id
   ]);
} 
...
'disable_web_page_preview'=>true,
 ...
 file_put_contents("Fri3nd_s/iBadlz.txt","MAFROTOO");
} 
$AFROTOO = count($pirvate)-1;
bot('sendMessage',[
          'chat_id'=>$chat_id,
          'text'=>"*📮• اهلا عزيزي الـمطور ، 
 ⚜• تم ارسال رسالتك الى $AFROTOO عضو ،💗ء*",
    'parse_mode'=>"MARKDOWN",
    'reply_to_message_id'=>$message->message_id
          ]);
}
...
bot('sendMessage',[
          'chat_id'=>$chat_id,
          'text'=>"*📮• اهلا عزيزي الـمطور ، 
⚜• تم توجيه رسالتك الى $AFROTOO عضو ،💗ء*",
'parse_mode'=>"MARKDOWN",
          'reply_to_message_id'=>$message->message_id
   ]);
}
...
▪️¦ عدد المجموعات المفعله : $Afrotoo 
📮¦ عدد المشتركين في البوت : $Afrotoo",
'parse_mode'=>"MARKDOWN",
          'reply_to_message_id'=>$message->message_id
]);
}
